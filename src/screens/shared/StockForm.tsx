...
export default function StockForm({ navigation, route }: Props) {
  ...
  const handleSave = async () => {
    ...
    if (isNaN(Number(quantite)))
      return Alert.alert('Erreur', 'Quantité invalide.');
    if (isNaN(Number(seuilAlerte)))
      return Alert.alert('Erreur', 'Seuil invalide.');
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.form}>
        ...
        <Field
          ...
          placeholder="Ex: boîte, flacon, pièce"
        />
        <Field
